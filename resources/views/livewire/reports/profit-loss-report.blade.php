            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body p-3 d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <div class="text-uppercase font-weight-bold small ">{{ __('reports::reports.card_sales', ['count' => $total_sales]) }}</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body p-3 d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <div class="text-uppercase font-weight-bold small">{{ __('reports::reports.card_sale_returns', ['count' => $total_sale_returns]) }}</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body p-3 d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <div class="text-uppercase font-weight-bold small">{{ __('reports::reports.card_profit') }}</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body p-3 d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <div class="text-uppercase font-weight-bold small">{{ __('reports::reports.card_purchases', ['count' => $total_purchases]) }}</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body p-3 d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <div class="text-uppercase font-weight-bold small">{{ __('reports::reports.card_purchase_returns', ['count' => $total_purchase_returns]) }}</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body p-3 d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <div class="text-uppercase font-weight-bold small">{{ __('reports::reports.card_expenses') }}</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body p-3 d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <div class="text-uppercase font-weight-bold small">{{ __('reports::reports.card_payments_received') }}</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body p-3 d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <div class="text-uppercase font-weight-bold small">{{ __('reports::reports.card_payments_sent') }}</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body p-3 d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <div class="text-uppercase font-weight-bold small">{{ __('reports::reports.card_payments_net') }}</div>
                    </div>
                </div>
            </div>
        </div>
