...
@section('title', __('adjustment::adjustments.edit_title'))
...
@section('breadcrumb')
    <ol class="breadcrumb border-0 m-0">
        ...
        <li class="breadcrumb-item active">{{ __('adjustment::adjustments.breadcrumb_edit') }}</li>
    </ol>
@endsection
                        ...
                        <form action="{{ route('adjustments.update', $adjustment) }}" method="POST">
                            ...
                            <div class="mt-3">
                                <button type="submit" class="btn btn-primary">
                                    {{ __('adjustment::adjustments.update_button') }} <i class="bi bi-check"></i>
                                </button>
                            </div>
                        </form>
                    </div>
