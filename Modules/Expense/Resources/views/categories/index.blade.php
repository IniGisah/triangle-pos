...
@section('title', __('expense::expenses.categories_title'))
...
@section('breadcrumb')
    <ol class="breadcrumb border-0 m-0">
        ...
        <li class="breadcrumb-item active">{{ __('expense::expenses.categories_breadcrumb') }}</li>
    </ol>
@endsection
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#categoryCreateModal">
                            {{ __('expense::expenses.category_add') }} <i class="bi bi-plus"></i>
                        </button>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="categoryCreateModalLabel">{{ __('expense::expenses.category_create_title') }}</h5>
                ...
                <form action="{{ route('expense-categories.store') }}" method="POST">
                    ...
                    <div class="modal-footer">
                        <button type="submit" class="btn btn-primary">{{ __('expense::expenses.category_create_button') }} <i class="bi bi-check"></i></button>
                    </div>
                </form>
            </div>
        </div>
