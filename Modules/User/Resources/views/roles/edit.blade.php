...
@section('title', __('user::user.role_edit_title'))
...
@section('breadcrumb')
    <ol class="breadcrumb border-0 m-0">
        ...
        <li class="breadcrumb-item active">{{ __('user::user.role_edit_title') }}</li>
    </ol>
@endsection
            ...
            <div class="col-md-12">
                ...
                <form action="{{ route('roles.update', $role->id) }}" method="POST">
                    ...
                    <div class="form-group">
                        <button type="submit" class="btn btn-primary">{{ __('user::user.role_edit_title') }} <i class="bi bi-check"></i>
                        </button>
                    </div>
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <label for="permissions">
                                    {{ __('user::user.permissions') }} <span class="text-danger">*</span>
                                </label>
                            </div>
