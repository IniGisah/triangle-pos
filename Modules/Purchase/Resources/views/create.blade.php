...
@section('title', __('purchase::purchase.purchases_create_title'))
...
@section('breadcrumb')
    <ol class="breadcrumb border-0 m-0">
        ...
        <li class="breadcrumb-item active">{{ __('purchase::purchase.purchases_create_title') }}</li>
    </ol>
@endsection
                    ...
                    <div class="card-body">
                        ...
                        <form id="purchase-form" action="{{ route('purchases.store') }}" method="POST">
                            ...
                            <div class="form-row">
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="status" id="status" required>
                                            <option value="Pending">{{ __('purchase::purchase.status_option_pending') }}</option>
                                            <option value="Ordered">{{ __('purchase::purchase.status_option_ordered') }}</option>
                                            <option value="Completed">{{ __('purchase::purchase.status_option_completed') }}</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="paid_amount">{{ __('purchase::purchase.paid_amount') }} <span class="text-danger">*</span></label>
                            ...
                            <div class="mt-3">
                                <button type="submit" class="btn btn-primary">
                                    {{ __('purchase::purchase.create_button') }} <i class="bi bi-check"></i>
                                </button>
                            </div>
                        </form>
                    </div>
