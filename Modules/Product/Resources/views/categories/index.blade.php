...
@section('title', __('product::product.categories_title'))
...
@section('breadcrumb')
    <ol class="breadcrumb border-0 m-0">
        ...
        <li class="breadcrumb-item active">{{ __('product::product.categories_breadcrumb') }}</li>
    </ol>
@endsection
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#categoryCreateModal">
                            {{ __('product::product.categories_add') }} <i class="bi bi-plus"></i>
                        </button>
