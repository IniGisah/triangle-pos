...
<head>
    ...
    <title>{{ __('salesreturn::salesreturn.returns_print_title') }}</title>
        ...
        <div class="col-xs-12">
            <div style="text-align: center;margin-bottom: 25px;">
                ...
                <h4 style="margin-bottom: 20px;">
                    <span>{{ __('salesreturn::salesreturn.reference_prefix') }}</span> <strong>{{ $sale_return->reference }}</strong>
                </h4>
            </div>
            <div class="card">
                <div class="card-body">
                    <div class="row mb-4">
                        <div class="col-xs-4 mb-3 mb-md-0">
                            <h4 class="mb-2" style="border-bottom: 1px solid #dddddd;padding-bottom: 10px;">{{ __('salesreturn::salesreturn.company_info') }}</h4>
                        ...
                        <div class="col-xs-4 mb-3 mb-md-0">
                            <h4 class="mb-2" style="border-bottom: 1px solid #dddddd;padding-bottom: 10px;">{{ __('salesreturn::salesreturn.customer_info') }}</h4>
                        ...
                        <div class="col-xs-4 mb-3 mb-md-0">
                            <h4 class="mb-2" style="border-bottom: 1px solid #dddddd;padding-bottom: 10px;">{{ __('salesreturn::salesreturn.invoice_info') }}</h4>
