...
@section('title', __('sale::sale.sales_create_title'))
...
@section('breadcrumb')
    <ol class="breadcrumb border-0 m-0">
        ...
        <li class="breadcrumb-item active">{{ __('sale::sale.sales_add') }}</li>
    </ol>
@endsection
                        ...
                        <form id="sale-form" action="{{ route('sales.store') }}" method="POST">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="status" id="status" required>
                                            <option value="Pending">{{ __('sale::sale.status_option_pending') }}</option>
                                            <option value="Shipped">{{ __('sale::sale.status_option_shipped') }}</option>
                                            <option value="Completed">{{ __('sale::sale.status_option_completed') }}</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                            ...
                            <div class="mt-3">
                                <button type="submit" class="btn btn-primary">
                                    {{ __('sale::sale.create_button') }} <i class="bi bi-check"></i>
                                </button>
                            </div>
                        </form>
                    </div>
